...
def generate_launch_description():
    return LaunchDescription([
        ...
        #Code added by Mahfuz Rahman
        DeclareLaunchArgument('max_vel', default_value = '0.2', description = 'max_vel (vel)'),
        DeclareLaunchArgument('vel_gain', default_value = '5.0', description = 'vel_gain (gain)'),
